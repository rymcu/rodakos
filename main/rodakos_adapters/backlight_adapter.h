...
//
// This adapter wraps the Board Manager LEDC device API to maintain
...
// BacklightAdapter wraps Board Manager LEDC control while preserving the original Backlight interface
